...
export async function seedTestDatabase() {
  ...
  const otherSeller = await prisma.sellerProfile.create({
    data: {
      ...
      address: "Other Market, Davao City",
      barangay: "Bajada",
  ...
  await prisma.product.createMany({
    data: [
      ...
      },
      {
        ...
        categoryId: "hotdogs",
        name: "Other Seller Hidden Hotdog",
        brand: "Other Brand",
        originalPriceCents: 25000,
        discountedPriceCents: 15000,
        discountPercent: 40,
        imageUrl: "/images/hotdogs.jpg",
        stockQuantity: 10,
        unit: "packs",
        expiryDate: new Date("2020-05-12T00:00:00.000Z"),
        pickupAddress: "Other Market, Davao City",
        pickupBarangay: "Bajada",
        pickupHours: "8:00 AM - 5:00 PM",
        description: "Existing product owned by another seller.",
        weight: "500g",
        packSize: "1 pack = 20 pcs",
        isHot: false,
        isFeatured: false,
      ...
      {
        id: "test-product-removed",
        sellerId: seller.id,
        categoryId: "hotdogs",
        name: "Removed Integration Hotdog",
        brand: "Purefoods",
        ...
        pickupBarangay: "Poblacion District",
        pickupHours: "7:00 AM - 5:00 PM",
        description: "Removed product that cannot be added to cart.",
        weight: "500g",
        packSize: "1 pack = 20 pcs",
        isHot: false,
        isFeatured: false,
